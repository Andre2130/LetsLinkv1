...
class _$CategoriesRecord extends CategoriesRecord {
  ...
  _$CategoriesRecord._({this.name, this.coverImage, this.reference})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc(0, name.hashCode), coverImage.hashCode), reference.hashCode));
  }
  ...
  _$CategoriesRecord build() {
    final _$result = _$v ??
        new _$CategoriesRecord._(
            name: name, coverImage: coverImage, reference: reference);
    replace(_$result);
    return _$result;
  }
}
